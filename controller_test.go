...
func TestSpeedControl_ControlLoop_OutputIncrease(t *testing.T) {
	...
	assert.Equal(t, float32(121), pidControl.State.ControlSignal)
	assert.Equal(t, float32(10), pidControl.State.ControlError)
}
...
func TestSpeedControl_ControlLoop_OutputDecrease(t *testing.T) {
	...
	assert.Equal(t, float32(0), pidControl.State.ControlSignal)
	assert.Equal(t, float32(0), pidControl.State.ControlError)
}
