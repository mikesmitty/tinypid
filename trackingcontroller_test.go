	...
	for _, tt := range []struct {
	...
	}{
		{
			...
			expectedState: TrackingControllerState{
				...
				ControlErrorDerivative:   1.0 / (seconds(dtTest) + seconds(c.Config.LowPassTimeConstant)),
				ControlSignal:            1.0,
		...
		},
		{
			...
			expectedState: TrackingControllerState{
				...
				ControlErrorIntegral:     0.0,
				ControlErrorDerivative:   50.0 / (seconds(dtTest) + seconds(c.Config.LowPassTimeConstant)),
				ControlSignal:            10.0,
